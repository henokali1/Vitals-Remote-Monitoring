...
void frmtMsg(){
  wifiMsg = "AT+NWHTC=http://54.166.105.47:9999/update_live/?heart_rate=" + heartrate_val + "&body_temp=" + body_temp_val + "&ecg="+ ecg + ",get";
  wifiMsg = "--" + heartrate_val + "--" + body_temp_val + "--" + ecg + "--";
